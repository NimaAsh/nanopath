...
# I-JEPA target mask: per image, the union of `n_blocks` contiguous square blocks (~block_scale of the
# grid each) — spatially-structured targets the predictor must regress, vs iBOT's scattered random patches.
